    ...
    <>
            ...
            <div className="max-w-screen-2xl container mx-auto md:px-20 px-4">
                <div className=" items-center justify-center text-center">
                    <h1 className="text-2xl pt-14 md:text-4xl">Welcome to SSS rent room <span className='text-pink-200'>here! :)</span></h1>
                ...
                <div>
                    <div className=' text-2xl m-2 font-bold'>Manishnagar</div>
                    <Slider {...settings}>
                        ...
                        <div className='mt-4 my-3 hover:scale-105 duration-200'>
                            <div className="card w-92 md:w-96 bg-base-100 shadow-xl">
                                ...
                                <div className="card-body">
                                    ...
                                    <div className="card-actions justify-between">
                                        <div className="badge badge-outline">price</div>
                                        <div className="cursor-pointer px-2 py-1 rounded-full border-[2px] hover:bg-pink-500 hover:text-white duration-300">See More Photos</div>
                                    </div>
                                </div>
                            </div>
                        </div>
